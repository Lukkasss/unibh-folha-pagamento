 ...
 */
public class Confianca extends Funcionarios{
    private final Double descontoVR = 1.0, descontoVT = 6.0;

    public Confianca(String matricula, String nome, String cpf, Double salario, Double bonus, Double vale_refeicao) {
        super(matricula, nome, cpf, vale_refeicao);
        super.setSalario(salario, bonus);
        super.setSalario(salario + super.getSalario());
    ...
    public Confianca(String matricula, String nome, String cpf, Double salario, Double bonus, Double vr, ArrayList<Dependentes> dep){
